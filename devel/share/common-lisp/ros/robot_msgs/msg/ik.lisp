...
(cl:defmethod cl:initialize-instance :after ((m <ik>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ik)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_msgs-msg:<ik> is deprecated: use robot_msgs-msg:ik instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <ik>))
